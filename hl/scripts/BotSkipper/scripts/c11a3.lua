function SpeedrunStart()
    ...
    CreateTimer( 2.15,ClientCmd, "wait;weapon_crossbow");
    CreateTimer( 3.0,ClientCmd, "fps_max 200"); 
    CreateTimer( 4.35, ClientCmd, "weapon_rpg;toggle_survival_mode;wait;toggle_survival_mode");
    CreateTimer( 4.524, ClientCmd, "kill;+attack2");
    CreateTimer( 4.59, ClientCmd, "fps_max 20");
    CreateTimer( 5.365, ClientCmd, "-duck" )
