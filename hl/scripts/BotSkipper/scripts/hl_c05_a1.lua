...
function SpeedrunStart()
    ...
    CreateTimer(31, ClientCmd, "-moveleft;-forward;sc_st_setangles_stop;sc_strafe_yaw \"\";sc_st_legit_mode_ignore_freeze 1");
end
...
--[[
    ...
    4th part---------------------------------------------------------------------------------
    CreateTimer(0.1, ClientCmd, "sv_cheats 3;wait;give weapon_handgrenade;wait;sv_cheats 0");
    CreateTimer(0.5, ClientCmd, "sc_im_play c05a1;wait;sc_im_goto 4983");
    CreateTimer(0.6, ClientCmd, "sc_im_split");
    CreateTimer(0.64, ClientCmd, "weapon_handgrenade;sc_strafe_yaw 130;sc_st_setangles 30 0 200");
    CreateTimer(1.374, ClientCmd, "sc_strafe_yaw 0");
    CreateTimer(1.7, ClientCmd, "+duck;sc_st_setangles 0 0 200");
    CreateTimer(1.9, ClientCmd, "+jump;sc_strafe_yaw -5");
    CreateTimer(2.0, ClientCmd, "-duck");
    CreateTimer(3.0, ClientCmd, "sc_strafe_yaw 100;sc_st_setangles 0 90 100");
    CreateTimer(3.2, ClientCmd, "sc_strafe_yaw 100");
    CreateTimer(3.4, ClientCmd, "+jump;-sc_ducktap");
    CreateTimer(3.82, ClientCmd, "sc_strafe_type 0;sc_strafe_yaw 0;sc_st_setangles 0 180 50;+jump;-sc_ducktap");
    CreateTimer(4, ClientCmd, "-moveleft;-jump");
    CreateTimer(4.15, ClientCmd, "+duck");
    CreateTimer(4.25, ClientCmd, "-duck;sc_strafe_yaw 169;sc_st_setangles 0 169 50;sc_strafe_ignore_ground 0");
    CreateTimer(4.45, ClientCmd, "sc_strafe_ignore_ground 1;+jump")
    CreateTimer(5.5, ClientCmd, "sc_strafe_yaw 105;sc_st_setangles 0 180 50");
    CreateTimer(5.9, ClientCmd, "sc_strafe_yaw 55;sc_st_setangles 0 -90 200");
    CreateTimer(6.4, ClientCmd, "sc_strafe_yaw ")
    CreateTimer(8, ClientCmd, "sc_im_stop");

    5th part lastoviy

    CreateTimer(0.1, ClientCmd, "sv_cheats 3;wait;give weapon_handgrenade;wait;sv_cheats 0");
    CreateTimer(0.2, ClientCmd, "weapon_handgrenade;setang 89 0 0;+attack");
    CreateTimer(0.9, ClientCmd, "-attack");
    CreateTimer(1.4, ClientCmd, "weapon_medkit;+attack2");
    CreateTimer(2.1, ClientCmd, "weapon_handgrenade;-attack2");
    CreateTimer(2.6, ClientCmd, "sc_im_play c05a1;wait;sc_im_goto 5910");
    CreateTimer(2.7, ClientCmd, "sc_im_split");
    CreateTimer(2.9, ClientCmd, "sc_strafe_yaw 111;sc_st_setangles 0 90 50;+jump");
    CreateTimer(3.42, ClientCmd, "sc_strafe_yaw -5;sc_st_setangles 0 -5 50;+attack");
    CreateTimer(4.05, ClientCmd, "setang 0 -85 0;+use;wait;-use");
    CreateTimer(4.051, ClientCmd, "setang 0 -5 0");
    CreateTimer(4.39, ClientCmd, "sc_strafe_yaw 90;sc_st_setangles 70 90 100");
    CreateTimer(4.5, ClientCmd, "-jump;+sc_ducktap");
    CreateTimer(5.0, ClientCmd, "sc_strafe_type 2");
    CreateTimer(5.23, ClientCmd, "-attack");
    CreateTimer(5.25, ClientCmd, "weapon_medkit");
    CreateTimer(5.27, ClientCmd, "sc_Strafe_type 0;-sc_ducktap;sc_strafe_yaw \"\";wait;sc_im_stop");
    CreateTimer(5.7, ClientCmd, "sc_strafe_yaw \"\"")
