...
function OnEndLoading()
    printl( "OnEndLoading()" );
    ClientCmd( "stop;record record_skipper_" .. MapName );
end
...
function IncludeMapScript( mapname )
    ...
    elseif ( mapname == "hl_c02_a1" ) then
        IncludeScript( "hl_c02_a1" );
    elseif ( mapname == "hl_c03" ) then
        IncludeScript( "c03_skopper" );
    elseif ( mapname == "hl_c07_a2" ) then
        IncludeScript( "c07_a2_skopper" );
    elseif ( mapname == "hl_c05_a1" ) then
    ...
    elseif ( mapname == "hl_c11_a1") then
        IncludeScript( "c11a1");
    elseif ( mapname == "hl_c11_a3") then
        IncludeScript( "c11a3");
    elseif ( mapname == "hl_c13_a4") then
        IncludeScript( "c13_a4_p4");
    end
