...
function SpeedrunInit()
    ...
    ClientCmd(" sc_st_disable_spread 0; -sc_ducktap; -jump; -duck; -forward; -back; -moveleft; -moveright; sc_strafe 0; sc_strafe_yaw \"\"; sc_strafe_ignore_ground 1; -attack; sc_im_stop");
...
function SpeedrunStartCustom()
    ...
    -- ClientCmd( "sc_im_play c08a2_pidor" );
    -- ClientCmd( "sc_im_record c08a2_pidor" );
    ...
    -- CreateTimer(12.250, ClientCmd,"sc_im_split");
    -- CreateTimer(5.200, ClientCmd,"weapon_crossbow");
    -- CreateTimer(10.000, ClientCmd,"sc_st_timescale 0.1");
