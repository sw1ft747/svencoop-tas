...
function SpeedrunStartCustom()
    ...
    CreateTimer(13.0, ClientCmd,"sc_strafe_vectorial_increment 0; sc_st_disable_spread 0");
    CreateTimer( 4.8, EnableSurvivalMode );
    ...
    CreateTimer(17.311, ClientCmd,"kill; -duck; say SDOH; sc_im_stop");
    CreateTimer(17.311, ClientCmd,"fps_max 20");
    CreateTimer(18.400, ClientCmd,"fps_max 200");
    CreateTimer(18.220, ClientCmd,"say revive");
    CreateTimer(18.420, ClientCmd,"sc_strafe_yaw \"\"");
