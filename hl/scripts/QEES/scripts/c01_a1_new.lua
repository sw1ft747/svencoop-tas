...
function SpeedrunStartCustom()
    ...
    CreateTimer(83.050, ClientCmd,"say open");
    CreateTimer(77.899, ClientCmd,"sc_im_stop");
    CreateTimer(81.644, ClientCmd,"sc_im_play c1a1_room");
...
function changefps()
    ClientCmd( "sc_im_record_command \"fps_max 20\"; wait; fps_max 20" );
    CreateTimer(0.2, ClientCmd,"sc_im_record_command \"fps_max 200\"; wait; fps_max 200" );
end
...
function OnPlayerUnstuck( pPlayerEdict )
    ...
    if ( pPlayerEdict.vars.netname == "QEES" ) then
        pPlayerEdict.vars.origin = Vector( -1919.938843, -2629.861572, -1182.629150 );
    end
end
