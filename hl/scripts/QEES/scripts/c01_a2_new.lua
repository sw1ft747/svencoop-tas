...
function SpeedrunStartCustom()
    ...
    --CreateTimer(6.750, ClientCmd,"sc_im_split");
    CreateTimer(4.610, ClientCmd,"npc_moveto");
    CreateTimer(7.985, ClientCmd,"sc_im_stop");
    CreateTimer(7.995, ba_start );
...
function OnPlayerSpawn( pSpawnSpotEdict, pPlayerEdict )
    ...
    if ( spawns_state == 0 ) then
        ...
        elseif ( sPlayerName == "void" ) then
            pPlayerEdict.vars.origin = Vector( 1618.937500, 12.375000, -323.968750 );             --1760.000000, -160.000000, -319.000000    
            pPlayerEdict.vars.angles = Vector( 0.000000, 90.000000, 0.000000 );  
