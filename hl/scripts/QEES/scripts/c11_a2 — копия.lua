...
function OnTouchTrigger(name)
	...
	if (name == "spawn") then
		...
		CreateTimer(7.500, ClientCmd,"sc_im_play c11_a2trybaaaaa");
		...
		CreateTimer(8.100, ClientCmd,"sc_im_play c11_a2HEADCRAB");

		CreateTimer(10.000, ClientCmd,"sc_im_stop");
		
	elseif (name == "tryba2") then
		ClientCmd("sc_im_stop");
		ClientCmd("sc_im_play c11_a2GodBoostV3");
