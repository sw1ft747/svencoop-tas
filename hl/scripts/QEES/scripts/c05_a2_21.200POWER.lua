...
function OnTouchTrigger(name)
	...
	if (name == "start") then
		...
		ClientCmd("sc_im_play c05_a2start2");
	...
	elseif (name == "PovorotGovna") then
		ClientCmd("sc_im_stop");
		ClientCmd("sc_im_play c05_a2PovorotGovna2");
	...
	elseif (name == "shit") then
		--CreateTimer(1.400, ClientCmd,"sc_st_timescale 0.1");
		ClientCmd("sc_im_stop");
		ClientCmd("sc_im_play c05_a2shit2");
	
	elseif (name == "drop") then
		--ClientCmd("say record");
		ClientCmd("sc_im_stop");
		ClientCmd("sc_im_play c05_a2drop2");

	elseif (name == "afterTop") then
		ClientCmd("sc_im_stop");
		--CreateTimer(2.000, ClientCmd,"sc_st_timescale 0.1");
		ClientCmd("sc_im_play c05_a2afterTop2");

	elseif (name == "power2") then
		ClientCmd("sc_im_stop");
		ClientCmd("sc_im_play c05_a2powerV2");
		--CreateTimer(1.300, ClientCmd,"sc_st_timescale 0.1");
		--ClientCmd("say record")

	elseif (name == "power3V2") then
		ClientCmd("sc_im_stop");
		ClientCmd("sc_im_play c05_a2powerV3");
		--ClientCmd("say record");

	elseif (name == "Fly") then
		ClientCmd("sc_im_stop");
		ClientCmd("sc_im_play c05_a2Fly");

	elseif (name == "15Sec") then
		ClientCmd("sc_im_stop");
		ClientCmd("setang 89.000000 90 0.000000");
		ClientCmd("sc_im_play c05_a2_15Sec");
