...
function SpeedrunInit()
    ...
    ClientCmd( "clockwindow 0; cl_smoothtime 0; mp_respawndelay 0; mp_classic_mode 1; fps_max 200; sc_jumpbug_min_fall_velocity 580; sc_st_legit_mode_ignore_freeze 1; sc_aimbot_change_angles_back 1; rcon_password 1337" );
end
...
function OnTouchTrigger(name)
    if ( name == "post_elevskip_qees" ) then
        CreateTimer( 0.15, ClientCmd, "sc_im_play c03_elevskip_qees" );
    ...
    elseif ( name == "post_ceilclip_qees" ) then
        ...
        CreateTimer( 0.15, ClientCmd, "sc_im_play c03_qees; wait; sc_strafe 1" );
    end
