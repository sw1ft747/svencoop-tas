...
function SpeedrunStart()
    ...
    CreateTimer(49.100, ClientCmd,"sc_im_stop");

    CreateTimer(0.180, ClientCmd,"sc_im_play c07a2_qees" );
    -- ClientCmd( "sc_im_record c07a2_qees" );
    -- ClientCmd( "sc_strafe 1; sc_debug_draw_box -5327.921875 -3270.352051 -607.96875 -2 -2 -2 2 2 2 0 255 0 50 1000000" );
    -- ClientCmd( "sc_strafe 1; sc_debug_draw_box -5327.921875 -3270.352051 -607.96875 -16 -16 -32 16 16 32 0 255 0 50 1000000" );
end

function OnServerSignal( value )
    if ( value == 1 ) then
        ClientCmd( "sc_im_play c07a2_qees_door_skip" );
        -- ClientCmd( "sc_im_record c07a2_qees_door_skip" );
    end
end
