...
function OnPlayerSpawn( pSpawnSpotEdict, pPlayerEdict )
    ...
    if ( UTIL_IsPointInsideAABB( pPlayerEdict.vars.origin,
                                Vector(1635.719, 285.312, -398.406),
                                Vector(1635.719, 285.312, -398.406) + Vector(211.656, 180.000, 222.094)) ) then

        if ( pPlayerEdict.vars.netname == "QEES" ) then
            pPlayerEdict.vars.origin = Vector( 1682, 322, -320 );
            pPlayerEdict.vars.angles = Vector( 0, 0, 0 );
        elseif ( pPlayerEdict.vars.netname == "kolokola777" ) then
            pPlayerEdict.vars.origin = Vector( 1682, 322, -320 );
            pPlayerEdict.vars.angles = Vector( 0, 0, 0 );
        elseif ( pPlayerEdict.vars.netname == "Sw1ft" ) then
            pPlayerEdict.vars.origin = Vector( 1693, 390, -320 );
            pPlayerEdict.vars.angles = Vector( 0, 0, 0 );
        elseif ( pPlayerEdict.vars.netname == "BotSkipper") then
            pPlayerEdict.vars.origin = Vector( 1755, 400, -320 );
            pPlayerEdict.vars.angles = Vector( 0, 0, 0 );
        end
    end
end
