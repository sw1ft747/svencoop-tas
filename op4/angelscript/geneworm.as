...
class monster_geneworm : ScriptBaseMonsterEntity {
	...
	void SetAnim(int animIndex) {
		...
		switch(animIndex){
		case GENEWORM_IDLE:
			g_EntityFuncs.FireTargets("strelyat", null, null, USE_TOGGLE, 0.0f, 0.0f);					
			break;			
		case GENEWORM_IDLEPAIN1:
			g_EntityFuncs.FireTargets("strelyat1", null, null, USE_TOGGLE, 0.0f, 0.0f);				
			break;	
		case GENEWORM_IDLEPAIN2:
			g_EntityFuncs.FireTargets("strelyat2", null, null, USE_TOGGLE, 0.0f, 0.0f);				
			break;	
		case GENEWORM_IDLEPAIN3:
			g_EntityFuncs.FireTargets("strelyat3", null, null, USE_TOGGLE, 0.0f, 0.0f);				
			break;	
		...
		case GENEWORM_BIGPAIN1:
			g_EntityFuncs.FireTargets("huylo", null, null, USE_TOGGLE, 0.0f, 1.0f);
