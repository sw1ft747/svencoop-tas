...
function SpeedrunStartCustom()
    ...
    CreateTimer(0.580, ClientCmd,"-forward");
    CreateTimer(0.610, ClientCmd,"gibme");
    CreateTimer(0.610, ClientCmd,"gibme");
    CreateTimer(0.610, ClientCmd,"gibme");
    CreateTimer(0.610, ClientCmd,"gibme");
    CreateTimer(0.615, ClientCmd,"setang -62 174");
    CreateTimer(0.620, ClientCmd,"+attack2");
    CreateTimer(0.625, ClientCmd,"setang 0 0");
    CreateTimer(0.740, ClientCmd,"-attack2");
    CreateTimer(0.740, ClientCmd,"sc_strafe_yaw \"\"");
...
function OnPlayerSpawn( pSpawnSpotEdict, pPlayerEdict )
    ...
    if ( spawns_state == 0 ) then
        ...
        elseif ( sPlayerName == "QEES" ) then
            pPlayerEdict.vars.origin = Vector( -2754, 2932, -76 ); 
            pPlayerEdict.vars.angles = Vector( -17, 179, 0 );
