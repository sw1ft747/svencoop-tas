...
function SpeedrunStartCustom()
    ...
    --CreateTimer(0.000, ClientCmd,"sc_im_record of1a4v5");
    CreateTimer(0.000, ClientCmd,"sc_im_play of1a4v5");
...
function OnPlayerSpawn( pSpawnSpotEdict, pPlayerEdict )
    ...
    if ( spawns_state == 0 ) then
        if ( sPlayerName == "QEES" ) then
            pPlayerEdict.vars.origin = Vector( -890.000, 431.000, 36.031 );
            pPlayerEdict.vars.angles = Vector( 0.000000, -90.000000, 0.000000 );
        elseif ( sPlayerName == "ialex" ) then
            pPlayerEdict.vars.origin = Vector( -835.000, 328.000, 36.031250 ); 
            pPlayerEdict.vars.angles = Vector( 0.000000, -90.000000, 0.000000 );
        end
    end
end
