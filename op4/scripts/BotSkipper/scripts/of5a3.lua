...
function SpeedrunStart()
    ...
    -- СТАРТ КАРРТЫ
    CreateTimer( 0.0, ClientCmd, "sc_strafe 1;kill;wait;toggle_survival_mode;sc_strafe_ignore_ground 0;mp_respawndelay 5000");

    --CreateTimer( 0.01, ClientCmd, "sc_im_play of5a3v1;setang 0 70 0;weapon_crossbow;sc_strafe_yaw \"\";setvel 0 0 0;sc_Strafe_type 0;sc_strafe 1;sc_strafe_ignore_ground 0" );
    --CreateTimer( 1.14, ClientCmd, "kill");
    CreateTimer( 8.765, ClientCmd, "kill");
...
function OnSpecialSpawn( pPlayerEdict )
    ...
    if ( revive_state == 0 ) then
        pPlayerEdict.vars.origin = Vector(-750.229187, -920.463806, 106.978783);
        pPlayerEdict.vars.angles = Vector( 0, 140, 0 );
        CreateTimer( 0.01, ClientCmd, "sc_im_play of5a3v2;weapon_crossbow");
    end    
end