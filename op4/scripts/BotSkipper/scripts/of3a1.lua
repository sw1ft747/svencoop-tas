...
function SpeedrunStart()
    ...
    CreateTimer( 2.05, ClientCmd, "-duck;-attack;weapon_9mmAR");
    CreateTimer( 2.3, ClientCmd, "gibme");
    CreateTimer( 2.3, ClientCmd, "gibme");
    CreateTimer( 2.3, ClientCmd, "gibme");
    CreateTimer( 2.56, ClientCmd, "+attack2;setang -60 90 0;+duck");
    CreateTimer( 2.57, ClientCmd, "wait;-attack2;wait;setang 0 -90 0");
    CreateTimer( 2.58, ClientCmd, "-duck");
...
function OnFireTargets( targetname, activator, caller, usetype, value, delay )
    if ( targetname == "tele_out_mgr1" ) then
